...
ACTIVITY="com.muslimqi.design.MainActivity"
...
# Exercise a real interaction on the fixed Pixel 6 smoke-test profile.
adb shell input tap 540 1690
sleep 2
...
echo "Muslim QI launch and interaction smoke test passed."
